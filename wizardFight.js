...
playSound("sound://category_background/fire_burning.mp3", false);
...
onEvent("Start", "click", function() {
  ...
  hideElement("kinglb");
  hideElement("Info");
  stopSound("sound://category_background/fire_burning.mp3");
  setScreen("loading");
  ...
  if (wenimyhp>0) {
    ...
    if (WeatherWizard==1) {
      if (playerattack>wenimydef) {
        ...
        showElement("wfire");
        playSound("Explosion croma key green screen, with explosion sound effect.mp3", false);
        setTimeout(function() {
          hideElement("wfire");
          stopSound("Explosion croma key green screen, with explosion sound effect.mp3");
        }, 1000);
      }
      if (wenimyattack>playerdef) {
        setTimeout(function() {
          ...
          setTimeout(function() {
            ...
            showElement("wred");
            playSound("Damage Sound Effect.mp3", false);
            setTimeout(function() {
              hideElement("wred");
      ...
      showElement("wcircle");
      playSound("Force Field 01 SOUND Effect.mp3", false);
      setTimeout(function() {
        stopSound("Force Field 01 SOUND Effect.mp3");
        hideElement("wcircle");
      }, 4000);
    } else {
      if (playerattack<wenimydef) {
  ...
  if (denimyhp>0) {
    ...
    if (DarkWizard==1) {
      ...
      if (denimyattack>playerdef) {
        setTimeout(function() {
          showElement("dspell");
          playSound("electric sound effect.mp3", false);
          setTimeout(function() {
            hideElement("dspell");
            stopSound("electric sound effect.mp3");
            showElement("dred");
            playSound("Damage Sound Effect.mp3", false);
            setTimeout(function() {
              hideElement("dred");
  ...
  if (ienimyhp>0) {
    ...
    if (IceWizard==1) {
      ...
      if (ienimyattack>playerdef) {
        setTimeout(function() {
          showElement("ispell");
          playSound("Fast Freezing ice SOUND Effect.mp3", false);
          setTimeout(function() {
            hideElement("ispell");
            stopSound("Fast Freezing ice SOUND Effect.mp3");
            showElement("ired");
            playSound("Damage Sound Effect.mp3", false);
            setTimeout(function() {
              hideElement("ired");
  ...
  if (kenimyhp>0) {
    ...
    if (King==1) {
      ...
      if (kenimyattack>playerdef) {
        setTimeout(function() {
          showElement("kspell");
          playSound("Energy explosion Sound Effect.mp3", false);
          setTimeout(function() {
            hideElement("kspell");
            stopSound("Energy explosion Sound Effect.mp3");
            showElement("kred");
            playSound("Damage Sound Effect.mp3", false);
            setTimeout(function() {
              hideElement("kred");
...
onEvent("reset", "click", function() {
  ...
  icedefeat = 0;
  kingdefeat = 0;
  stopSound("Creepy Dungeon Ambience.mp3");
